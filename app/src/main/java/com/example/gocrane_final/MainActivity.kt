package com.example.gocrane_final
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todoB.setOnClickListener {
            Toast.makeText(this, "Report Order", Toast.LENGTH_SHORT).show()
        }
        ...
        practiceCard.setOnClickListener {
            Toast.makeText(this, "Data Order", Toast.LENGTH_SHORT).show()
        }
        learnCard.setOnClickListener {
            Toast.makeText(this, "History Order", Toast.LENGTH_SHORT).show()
        }
        interestsCard.setOnClickListener {
            Toast.makeText(this, "Report Monthly", Toast.LENGTH_SHORT).show()
        }
